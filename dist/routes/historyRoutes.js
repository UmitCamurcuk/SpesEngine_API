...
router.get('/', (0, auth_middleware_1.checkAccess)(['HISTORY_VIEW']), historyController.getHistory);
// GET /api/history/:entityId - Belirli entity'nin history kayıtlarını getir
router.get('/:entityId', (0, auth_middleware_1.checkAccess)(['HISTORY_VIEW']), historyController.getEntityHistory);
